...
try:
    ...
    print("Warning: nvdiffrast not found. Mesh rendering will fail.")
    dr = None

try:
    import mcubes
except ImportError:
    print("Warning: mcubes not found. Mesh extraction will fail.")
    mcubes = None

try:
    import raymarching
except ImportError:
    print("Warning: raymarching not found. Using slower PyTorch fallback if available.")
    raymarching = None
